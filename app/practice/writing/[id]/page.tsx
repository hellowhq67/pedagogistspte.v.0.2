...
export default function WritingPracticePage() {
    ...
    useEffect(() => {
        async function loadQuestions() {
            try {
                const data = await getPteQuestions(TestSection.WRITING);
                setQuestions(data);
            } catch (error) {
                ...
                <div className="flex-1 flex flex-col min-w-0">
                    ...
                    <header className="border-b bg-card/50 backdrop-blur sticky top-0 z-10">
                        <div className="px-4 py-3 flex items-center gap-4">
                            ...
                            <h1 className="text-lg font-bold gradient-text">Writing Practice</h1>
                        </div>
                    </header>
                        ...
                        <Tabs defaultValue="practice" className="space-y-6 max-w-4xl mx-auto">
                            ...
                            <TabsContent value="practice">
                                <div className="text-center py-12">
                                    <h2 className="text-2xl font-bold mb-2">Writing Practice</h2>
                                    {loading ? (
                                        ...
                                        <p className="text-muted-foreground">
                                            No writing questions available yet.
                                        </p>
                                    )}
                                </div>
                            </TabsContent>
