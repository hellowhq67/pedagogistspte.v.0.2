...
import { CheckCircle2, AlertCircle, TrendingUp, BookOpen, Target, Search, MousePointerClick, Brain } from 'lucide-react'
...
export default function ReadingResults({ scoreData }: ReadingResultsProps) {
    ...
    const criteria = [
        ...
        { label: 'Reasoning', data: scoreData.reasoning, icon: Search, max: 1 },
    ].filter(item => item.data !== undefined)

    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
            {/* Overall Score Large Card */}
            <div className="relative overflow-hidden rounded-[40px] bg-gradient-to-br from-emerald-900 to-teal-950 p-1">
                <div className="bg-background rounded-[38px] p-8 md:p-12 relative overflow-hidden">
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-between gap-12 relative z-10">
                        <div className="text-center md:text-left space-y-4">
                            <Badge className="bg-emerald-500/10 text-emerald-500 border-none font-black uppercase tracking-widest text-[10px] px-4 py-1">
                                Reading Proficiency
                            </Badge>
                            <h2 className="text-4xl md:text-5xl font-black tracking-tight text-foreground">Reading <br/>Performance</h2>
                            <p className="text-muted-foreground font-medium text-lg max-w-md">Detailed analysis of your comprehension and vocabulary usage in context.</p>
                        </div>
                        ...
                        <div className="relative flex items-center justify-center">
                            <div className="size-48 md:size-56 rounded-full border-8 border-muted flex flex-col items-center justify-center relative">
                                <span className="text-6xl md:text-7xl font-black tracking-tighter text-emerald-600">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="p-8 rounded-[40px] bg-emerald-500/5 border border-emerald-500/10 space-y-6">
                    <div className="flex items-center gap-3 text-emerald-600">
                        ...
                        <h4 className="font-black text-sm uppercase tracking-widest">Mastery Areas</h4>
                    </div>
                ...
                <div className="p-8 rounded-[40px] bg-rose-500/5 border border-rose-500/10 space-y-6">
                    <div className="flex items-center gap-3 text-rose-600">
                        ...
                        <h4 className="font-black text-sm uppercase tracking-widest">Contextual Gaps</h4>
                    </div>
                    <ul className="space-y-3">
